...
<head>
    ...
    <link rel="stylesheet" href="css/board_form_list.css">
    <link rel="stylesheet" href="css/board_form_list_title.css">
...
?>
			...
			<ul class="buttons">
				<li><button onclick="location.href='board_form_list.php'">목록</button></li>
				<li>
<?php 
    if($id) {
?>
