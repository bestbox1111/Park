...
<head>
    ...
    <link rel="stylesheet" href="css/mediascreen_notice_form.css">

  
    <script src="js/notice_form.js"></script>
    ...
    <nav>
        ...
        <div class="write">
            ...
            <div class="write_center">
              ...
              <form action="notice_insert.php" method="post" name="notice_form" enctype="multipart/form-data">
